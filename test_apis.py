...
class APITest(unittest.TestCase):
    ...
    def test_delete_bucket_without_token(self):
        """Test deleting a bucketlist."""
        self.user_registration()
        logged = self.login_the_user()
        token = json.loads(logged.data.decode())['token']
        ...
        self.assertIn('problem with token login again', str(res.data))
    ...
    def test_create_item(self):
        ...
        self.assertIn('a simmilar item name exists', str(res2.data))
    ...
    def test_edit_item(self):
        ...
        self.assertIn('buy clothes and shoes', str(res2.data))
